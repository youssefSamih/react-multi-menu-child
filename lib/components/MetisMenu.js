...
var MetisMenu = /*#__PURE__*/function (_React$Component) {
  ...
  function MetisMenu(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "componentDidUpdate", function (nextProps) {
      ...
      if (_this.props.ajax !== nextProps.ajax) {
        _this.updateRemoteContent(nextProps);
      } else if (_this.props.activeLinkId !== nextProps.activeLinkId || _this.props.activeLinkTo !== nextProps.activeLinkTo || _this.props.activeLinkLabel !== nextProps.activeLinkLabel || _this.props.activeLinkFromLocation !== nextProps.activeLinkFromLocation) {
        _this.updateActiveLink(nextProps);
      }
    });
    _defineProperty(_assertThisInitialized(_this), "updateRemoteContent", /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _context.next = 4;
                return (0, _axios["default"])(props.ajax);
              case 4:
              ...
              case 9:
                ...
                throw new Error("MetisMenu: Ajax response expected to be json, but got; ".concat(responseData.data));
              case 12:
    ...
    _this.useExternalReduxStore = _props.useExternalReduxStore;
    _this.reduxStoreName = _props.reduxStoreName;
    if (_this.useExternalReduxStore) {
      _this.store = _this.useExternalReduxStore;
    } else {
      _this.store = (0, _redux.createStore)(_internal["default"]);
    }
    if (_props.onSelected) {
      _this.store.dispatch((0, _emitters.updateListener)(_this.reduxUid, _props.onSelected));
    }
    _this.LinkComponent = _props.LinkComponent;
    if (_props.content) {
      _this.updateContent(_props.content);
      _this.updateActiveLink(_props);
    } else if (_props.ajax) {
      _this.updateRemoteContent(_props);
    }
    _this.classStore = {
      classMainWrapper: (0, _classnames["default"])({
        metismenu: !_props.noBuiltInClassNames
      }, _props.className),
      classContainer: typeof _props.classNameContainer === 'function' ? _props.classNameContainer : (0, _classnames["default"])({
        'metismenu-container': !_props.noBuiltInClassNames
      }, _props.classNameContainer),
      classContainerVisible: (0, _classnames["default"])({
        visible: !_props.noBuiltInClassNames
      }, _props.classNameContainerVisible),
      classItem: (0, _classnames["default"])({
        'metismenu-item': !_props.noBuiltInClassNames
      }, _props.classNameItem),
      classLink: (0, _classnames["default"])({
        'metismenu-link': !_props.noBuiltInClassNames
      }, _props.classNameLink),
      classItemActive: _props.classNameItemActive,
      classItemHasActiveChild: _props.classNameItemHasActiveChild,
      classItemHasVisibleChild: _props.classNameItemHasVisibleChild,
      classLinkActive: (0, _classnames["default"])({
        active: !_props.noBuiltInClassNames
      }, _props.classNameLinkActive),
      classLinkHasActiveChild: (0, _classnames["default"])({
        'has-active-child': !_props.noBuiltInClassNames
      }, _props.classNameLinkHasActiveChild),
      classIcon: (0, _classnames["default"])({
        'metismenu-icon': !_props.noBuiltInClassNames
      }, _props.classNameIcon),
      classStateIcon: (0, _classnames["default"])({
        'metismenu-state-icon': !_props.noBuiltInClassNames
      }, _props.classNameStateIcon),
      iconNamePrefix: _props.iconNamePrefix,
      iconNameStateHidden: _props.iconNameStateHidden,
      iconNameStateVisible: _props.iconNameStateVisible
    };
    return _this;
  }
...
MetisMenu.propTypes = {
  ...
  ajax: _propTypes["default"].object,
