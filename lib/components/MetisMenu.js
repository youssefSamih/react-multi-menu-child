...
var _simpleAjax = _interopRequireDefault(require("simple-ajax"));
...
var MetisMenu = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(MetisMenu, [{
    ...
    value: function updateRemoteContent(props) {
      var _this2 = this;
      var ajax = new _simpleAjax["default"](props.ajax);
      ajax.on('success', function (event) {
        ...
        try {
          ...
          throw new Error("MetisMenu: Ajax response expected to be json, but got; ".concat(responseText));
        }
...
MetisMenu.propTypes = {
  ...
  ajax: _propTypes["default"].oneOfType([_propTypes["default"].object, _propTypes["default"].string]),
